...
public class TransactionsTest
{
	...
	public static async Task ClassInitialize(TestContext context)
	{
		...
		await stockFetcher.GetHistory("O", "NYSE", DateOnly.Parse("2022-06-06"), DateOnly.Parse("2023-01-01"), "daily", "USD");
	}
	...
	// TODO: Test for new dividend being added, also being added to dividendpayout - testing DividendPayoutInsert trigger
}