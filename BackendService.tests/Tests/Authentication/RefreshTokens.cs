...
public class RefreshTokensTest
{
	...
	{
		StockApp.TokenSet response = Authentication.RefreshTokens.All("NON_EXISTENT_TOKEN", 0);
	...
	{
		StockApp.TokenSet response = Authentication.RefreshTokens.All(Assembly.refreshToken, 0);
